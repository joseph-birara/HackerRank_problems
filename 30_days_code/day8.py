...
# and Maps
# Objective
# Today, we're learning about Key-Value pair mappings using a Map or Dictionary data structure. Check out
...
# each queried, print the associated entry from your phone book on a new line in the form
...
# We then process each query and print key=value if the queried is found in the map; otherwise, we
# print Not found .
# Query 0: sam
